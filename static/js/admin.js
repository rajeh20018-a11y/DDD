...
function renderAll(){
  ...
  renderChart(summary.daily);renderDonut(summary.experiences,t.interests||0);renderRecent(interests.slice(0,5));renderInterests();renderMessages(messages);renderAnalytics(analytics);
